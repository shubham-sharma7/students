<template>
  <div class="bg-gray-300" style="height:100vh">
    <h1 class="text-center pt-4" style="font-size:1.5em">Add New Student</h1>
...
export default {
  ...
  methods: {
    async addStudent() {
        try {
            await axios.post('https://students-5fc25-default-rtdb.firebaseio.com/st_list.json', this.student).then((res) => {
